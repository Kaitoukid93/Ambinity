...
namespace Ambinity.Installer.Utilities;
...
public class ShortcutUtilities
{
    ...
    {
        IWshShortcut shortcut = (IWshShortcut)MType.InvokeMember("CreateShortcut", BindingFlags.InvokeMethod, null,
            MShell, new object[] { fileName });
        if (shortcut == null)
