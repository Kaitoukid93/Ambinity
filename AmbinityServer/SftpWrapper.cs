...
namespace AmbinityServer
{
    public class SftpWrapper
    {
        ...
        {
            Log.Information("SFTP auto-disconnecting due to inactivity.");
            Disconnect();
        }
        ...
        private void ResetInactivityTimer()
        {
            lock (_lock)
            {
                ...
                _inactivityTimer = new Timer(OnInactivityTimeout, null, _inactivityTimeout, Timeout.InfiniteTimeSpan);
            }
        }
