...
public class SerialLEDControllerHardwareSettings : ObservableObject, ILEDControllerHardwareSettings
{
    ...
    private bool _isHardwareLightingEnable = false;

    /// <summary>
    /// Enable lighting without app running in the background
    /// </summary>
    public bool IsHardwareLightingEnable
    {
        get => _isHardwareLightingEnable;
        set => SetProperty(ref _isHardwareLightingEnable, value);
    }
    ...
    private int _hwl_version = 0;
    private int _hwl_MaxLEDPerOutput = 80;
    ...
    public int HWL_version
    {
        get => _hwl_version;
        set => SetProperty(ref _hwl_version, value);
    }

    public int HWL_MaxLEDPerOutput
    {
