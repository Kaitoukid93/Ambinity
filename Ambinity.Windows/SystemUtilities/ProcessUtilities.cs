...
public static class ProcessUtilities
{
    ...
    public static Process? RunAsDesktopUser(string fileName, string arguments, bool hideWindow)
    {
        ...
        try
        {
            ...
            if (!CreateProcessWithTokenW(hPrimaryToken, 0, fileName, $"\"{fileName}\" {arguments}", 0, IntPtr.Zero,
                    Path.GetDirectoryName(fileName)!, ref si, out pi))
            {
    ...
    private static extern bool CreateProcessWithTokenW(IntPtr hToken, int dwLogonFlags, string lpApplicationName,
        string lpCommandLine, int dwCreationFlags, IntPtr lpEnvironment,
