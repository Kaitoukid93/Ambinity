...
/// </summary>
public class ZoneMappingToolsViewModel
{
    public event Action FitCanvasToViewEvent;
    public event Action ToggleSnapToGridEvent;

    public ZoneMappingToolsViewModel(GeneralSettingsManager settingsManager)
    {
    ...
    public void Init()
    {
        ...
        FlyoutItem addAmbilightZone = new FlyoutItem("Ambilight", "Ambilight_addzone");
