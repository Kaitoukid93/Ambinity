...
namespace adrilight
{
    ...
    /// </summary>
    internal class DesktopDuplicatorThird : ViewModelBase, IDisposable , IDesktopDuplicatorThird
    {
        ...
        public DesktopDuplicatorThird(IGeneralSettings userSettings)
        {
           ...
           // mainView.PropertyChanged += PropertyChanged;
            ...
            var whichOutputDevice = 2;
            Adapter1 adapter;
            if (UserSettings.ShouldbeRunningThird)
            {
                try
                {
