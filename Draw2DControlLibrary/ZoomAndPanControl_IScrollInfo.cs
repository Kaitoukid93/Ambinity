...
namespace Draw2DControlLibrary
{
    ...
    public partial class ZoomAndPanControl
    {
        ...
        /// <summary>
        /// avalonia inheritance
        /// </summary>
        public Size Extent => new Size(ExtentWidth, ExtentHeight);

        public Size Viewport => new Size(ViewportWidth, ViewportHeight);

        public Vector Offset
        {
            get { return new Vector(HorizontalOffset, VerticalOffset); }
            set
            {
                SetHorizontalOffset(value.X);
