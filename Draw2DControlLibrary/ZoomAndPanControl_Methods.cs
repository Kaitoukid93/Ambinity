...
namespace Draw2DControlLibrary
{
    public partial class ZoomAndPanControl
    {
        ...
        public void AnimatedZoomTo(Rect contentRect)
        {
            ...
            AnimatedZoomPointToViewportCenter(contentFitZoom,
        ...
        public void AnimatedSnapTo(Point contentPoint)
        {
            ...
            AnimationHelper.StartAnimation<double>(this, ContentOffsetXProperty, newX, AnimationDuration);
            AnimationHelper.StartAnimation<double>(this, ContentOffsetYProperty, newY, AnimationDuration);
        }
        ...
        public void AnimatedZoomAboutPoint(double newContentZoom, Point contentZoomFocus)
        {
            ...
            AnimationHelper.StartAnimation<double>(this, ViewportZoomProperty, newContentZoom, AnimationDuration,
                (sender, e) =>
                {
        ...
        /// </summary>
        private void AnimatedZoomPointToViewportCenter(double newContentZoom, Point contentZoomFocus,
            EventHandler callback)
        {
            ...
            AnimationHelper.StartAnimation<double>(this, ViewportZoomFocusXProperty, ViewportWidth / 2, AnimationDuration);
            AnimationHelper.StartAnimation<double>(this, ViewportZoomFocusYProperty, ViewportHeight / 2, AnimationDuration);
        }
